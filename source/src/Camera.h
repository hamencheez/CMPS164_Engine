...
public:
	...
	void setCamTargPos(float xPos, float yPos, float zPos){
		camTargX = xPos;
		camTargY = yPos;
		camTargZ = zPos;
	...
	glm::vec3 getCamTargPos(){return glm::vec3(camTargX, camTargY, camTargZ);}

	void update(CameraSetting camSetting);
	void keepDistance();
